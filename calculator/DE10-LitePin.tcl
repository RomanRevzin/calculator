...
#   *** Pin Assignment ***    
   set_location_assignment PIN_D15 -to HEXdp[0]  ;# DP[0]
   set_location_assignment PIN_A16 -to HEXdp[1]  ;# DP[1]
   set_location_assignment PIN_A19 -to HEXdp[2]  ;# DP[2]
   set_location_assignment PIN_D22 -to HEXdp[3]  ;# DP[3]
   set_location_assignment PIN_F17 -to HEXdp[4]  ;# DP[4]
   set_location_assignment PIN_L19 -to HEXdp[5]  ;# DP[5]
